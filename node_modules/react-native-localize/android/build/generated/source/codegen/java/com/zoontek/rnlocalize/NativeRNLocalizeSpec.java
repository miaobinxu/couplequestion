...
public abstract class NativeRNLocalizeSpec extends ReactContextBaseJavaModule implements TurboModule {
  ...
  public NativeRNLocalizeSpec(ReactApplicationContext reactContext) {
    super(reactContext);
  }
  ...
  @ReactMethod(isBlockingSynchronousMethod = true)
  @DoNotStrip
  public abstract @Nullable Boolean usesAutoDateAndTime();

  @ReactMethod(isBlockingSynchronousMethod = true)
  @DoNotStrip
  public abstract @Nullable Boolean usesAutoTimeZone();
